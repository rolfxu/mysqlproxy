...
public class SimpleChannelPool implements ChannelPool {
    ...
    protected final Deque<Channel> deque = PlatformDependent.newConcurrentDeque();
     ...
     *
     * @param bootstrap         the聽{@link Bootstrap} that is used for connections
