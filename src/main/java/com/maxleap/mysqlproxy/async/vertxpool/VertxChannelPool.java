package com.maxleap.mysqlproxy.async.vertxpool;
...
import com.maxleap.mysqlproxy.async.pool.ChannelAttributes;
import com.maxleap.mysqlproxy.async.pool.ChannelConnector;
import com.maxleap.mysqlproxy.async.pool.ExtendedChannelPool;
...
public class VertxChannelPool implements ExtendedChannelPool{
    /**
    ...
    public VertxChannelPool(  InetSocketAddress address, ChannelConnector connector, Bootstrap bootstrap, NettyChannelPoolHandler handler,
